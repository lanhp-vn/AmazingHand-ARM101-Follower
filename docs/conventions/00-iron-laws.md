...
- **Hand calibration** lives in `scripts/calibration/amazing_hand/hand_calib_values.yaml`. The three calibration scripts (`motor_reset.py`, `middle_calib.py`, `finger_test.py`) read from and write to that file.
